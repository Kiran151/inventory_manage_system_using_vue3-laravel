                    ...
                    <form @submit.prevent="update" enctype="multipart/form-data">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-3">
                                ...
                                <img v-if="form.updatedImage==null" :src="form.image == null ? '/assets/images/no_image.jpg' : `/uploads/employee/${form.image}`"
                                    alt="image" class="img-fluid avatar-xl border rounded shadow">
...
export default {
    ...
    created() {
        ...
        axios.get('/api/employee/edit_employee/' + id)
            .then(res => {
    ...
    methods: {
        update() {
            let id = this.$route.params.id;
            axios.patch(`/api/employee/update_employee/${id}`, this.form)
            .then(res => {
                console.log(res);
                if (res.data == 'success') {
