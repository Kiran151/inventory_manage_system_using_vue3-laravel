                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <router-link to="/add_customer">
                            <button type="button" class="btn btn-danger waves-effect waves-light mb-2">
                                <i class="mdi mdi-plus-box me-1"></i> Add Customer
                            </button>
                        </router-link>
...
const columns = [
    ...
    },
    {
        ...
        render: function (data, type, row) {
            const imageUrl = data !== null ? `uploads/customer/${data}` : 'assets/images/no_image.jpg';
            return `
...
export default {
    ...
    methods: {
        fetchData() {
            const apiUrl = '/api/customer/all_customer';
            axios.get(apiUrl)
                .then(response => {
